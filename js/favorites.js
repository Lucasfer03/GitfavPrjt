...
export class Favorites {
  ...
  load() {
    this.entries = JSON.parse(localStorage.getItem
      ('@github-favorites:')) || []
    console.log('aaaaaaaaaaaaaaaaaaaaa', this.entries)
...
export class FavoritesView extends Favorites {
  ...
  update() {
    ...
    this.entries.forEach(user => {
      ...
      row.querySelector('.remove').onclick = () => {
        const isOk = confirm('Vai deletar mesmo? :-( ')
        if (isOk) {
          this.delete(user)
        }
      }
  ...
  createRow() {
    ...
    <td class="user">
      <img src="https://github.com/Lucasfer03.png" alt="Imagem de lucas">
      <a href="https://github.com/Lucasfer03">
        <p>Lucas Cunha</p>
        <span>Lucasfer03</span>
      </a>
    </td>
    <td class="repositories">33</td>
    <td class="followers">877</td>
    <td>
